...
namespace SEDC.PizzaApp.Refactored.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IMenuService menuService, IUserService userService)
        {
            _logger = logger;
        ...
        {
            var feedBackViewModel = new List<FeedbackViewModel>();
               var feedbacksDB = _userService.GetAllFeedbacks();
            foreach (var feed in feedbacksDB)
            {
                feedBackViewModel.Add(new FeedbackViewModel()
                {
                     Name = feed.Name,
                     Email = feed.Email,
