    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Feedbacks", x => x.UserId);
                });
            ...
            migrationBuilder.InsertData(
                table: "Feedbacks",
                columns: new[] { "UserId", "Email", "Message", "Name" },
                values: new object[,]
                {
                    { 1, "Pero@email.com", "Picata kasnese 20 minuti, ladna mi ja donesovte!!!", "Pero" },
                    { 12, "Blazo@email.com", "Picata e top!!!", "Blazo" }
                });
