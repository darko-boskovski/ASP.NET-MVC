    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "Company", "EmailAddress", "FullName", "MobilePhone" },
                values: new object[,]
                {
                    { 1, "PolarCape", "jobs_mk@polarcape.com", "Polar Cape Macedonia", 76361019L },
                    { 2, "CompanyTwo", "company_mk@fake.com", "Fake Company Macedonia", 70000000L }
                });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "EmailAddress", "EmployeeNumber", "FullName", "MobilePhone" },
                values: new object[,]
                {
                    { 1, "darkoboskovski.01@gmail.com", 1, "Darko Boshkovski", 75456697L },
                    { 2, "johndoe@gmail.com", 2, "John Doe", 77777777L },
                    { 3, "janedoe@gmail.com", 3, "Jane Doe", 73333333L }
                });
