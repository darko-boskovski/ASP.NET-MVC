    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult GetOrderDetails(int id=1)
        {
            Pizza pizza = new Pizza()
            {
                Id = 1,
                Name = "Pepperoni",
                Size = Models.Enums.PizzaSize.Medium,
                Price = 300
            ...
            MyOrderDetailsViewModel myDetails = new MyOrderDetailsViewModel()
            {
                Id = order.Id,
                FullName = $"{person.FirstName} {person.LastName}",
                Pizza = pizza.Name,
            ...
            if (id != myDetails.Id) return new EmptyResult();
